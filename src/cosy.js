/**
 * Qoder COSY (hybrid RSA+AES+MD5) signing — extracted from 9Router's
 * open-sse/shared/qoder/cosy.js (originally ported from CLIProxyAPIPlus's
 ...
 *
 * Zero npm dependencies: uuid replaced by crypto.randomUUID().
 */
...
/**
 * Generate a fresh machine UUID. Persist on your credential record so
 ...
 * @param {string} creds.authToken         Device token (dt-...) or job token (jt-...).
